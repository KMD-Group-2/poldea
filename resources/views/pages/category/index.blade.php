    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-5 align-self-center">
                <h4 class="text-themecolor">Category Management</h4>
            </div>
    ...
    <div class="right-sidebar" style="margin-top: 67px;">
        <div class="slimscrollright">
            ...
            <div class="r-panel-body mb-5">
                ...
                <form action="{{ route('admin.category.update', ['category' => ':id']) }}" method="PUT" id="UpdateCategoryForm">
                    @csrf
                    <div class="row mt-4">
                        <div class="col-12">
                ...
                <div class="row mt-2">
                    <div class="col-12 text-center">
                        <button type="button" class="btn btn-outline-danger" data-delete="no-select"
                            ...
                            action="{{ route('admin.category.destroy', ['category' => ':id']) }}" method="DELETE">Delete
                            Category</button>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.category.store') }}" method="POST" id="StoreCategoryForm">
                        @csrf
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-info waves-effect waves-light" form="StoreCategoryForm"
                        id="StoreCategoryBtn">Add New Category</button>
                </div>
            </div>
        </div>
    </div>
