<x-app-layout>
        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <button type="button" class="btn btn-info d-none d-lg-block m-l-15" data-toggle="modal" data-target="#add-new-user-modal"><i class="fa fa-plus-circle"></i> Add New User</button>
                </div>
            </div>
        </div>
        <div class="row">
                                ...
                                <tbody>
                                    @if ($users->total() > 0)
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="{{ $user->staff->photo ?? '' }}" alt="user" class="" style="width:36px;"> {{ $user->username }}</td>
                                            <td><span class="btn waves-effect waves-light btn-sm btn-secondary" style="width:100px;">{{ $user->getRoleNames()[0] }}</span></td>
    ...
    <div id="add-new-user-modal" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.user.store') }}" method="POST" id="StoreUserForm">
                        ...
                        <div class="form-group" style="margin-bottom: 5px">
                            ...
                            <select class="select2 form-control custom-select" name="staff_id" style="width: 100%;" id="cboStaff">
                        ...
                        <div class="form-group" style="margin-bottom: 5px">
                            ...
                            <select class="select2 form-control custom-select" name="role_id" style="width: 100%;" id="cboUserRole">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-info waves-effect waves-light" onclick="addNewUser()">Add New User</button>
                </div>
            </div>
        </div>
    </div>
